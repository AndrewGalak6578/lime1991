    ...
    <div class="personal-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <form action="{{ route('front.userAddresses.store')}}" method="POST"> @csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-group">
                                <input name="street" id="street" value="{{ old('street') }}" required type="text" placeholder="Улица *" class="form-control address_input">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                <input name="house" id="house" value="{{ old('house') }}" required type="text" placeholder="Дом *" class="form-control address_input">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                <input name="entrance" id="entrance" value="{{ old('entrance') }}" type="text" placeholder="Подъезд" class="form-control address_input">
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="form-group">
                                <input name="floor" id="floor" value="{{ old('floor') }}" type="text" placeholder="Этаж" class="form-control address_input">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
