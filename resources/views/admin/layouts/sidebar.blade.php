...
<div class="fixed-content-box">
    ...
    <div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
        <div class="tab-content" id="menu">
            <div class="tab-pane fade {{ active(['admin.dashboard', 'admin.callmes.*', 'admin.reviews.*'], 'show active') }}" id="dashboard" role="tabpanel">
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.orders.index', ['status'=>0]) }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="{{ active('admin.reviews.*', 'mm-active') }}">
                    ...
                    <li class="{{ active('admin.callmes.*', 'mm-active') }}">
                        <a href="{{ route('admin.callmes.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
            ...
            <div class="tab-pane fade {{ active(['admin.orders.*'], 'show active') }}" id="apps">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Продажи</li>

                    <li class="{{ active('admin.orders.*', 'mm-active') }}">
                    ...
                    <li>
                        <a  href="{{ route('admin.orders.index', ['status'=>0]) }}" aria-expanded="false">
                            ...
                            <span class="nav-text">Новые продажи</span>
                            {{--                            <span class="badge badge-xs badge-light">10</span>--}}
                        </a>
                    </li>
                    <li>
                        <a  href="{{ route('admin.orders.index', ['status'=>3]) }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="nav-text">Отмены</span>
                        </a>
                    </li>
                    <li>
                        <a  href="{{ route('admin.orders.index', ['status'=>4]) }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="nav-text">Завершенные</span>
                        </a>
                    </li>
                    <li>
            ...
            <div class="tab-pane fade  {{ active(['admin.products.*', 'admin.parser.*'], 'show active') }}" id="products">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Товары</li>
                    <li class="{{ active('admin.products.products.*', 'mm-active') }}">
                        <a  href="{{ route('admin.products.products.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="{{ active('admin.products.productCategories.*', 'mm-active') }}">
                        <a  href="{{ route('admin.products.productCategories.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="{{ active('admin.products.productTags.*', 'mm-active') }}">
                        <a  href="{{ route('admin.products.productTags.index') }}" aria-expanded="false">
                    ...
                    <li class="{{ active(['admin.products.chars.*', 'admin.products.charValues.*', 'admin.products.charGroups.*'], 'mm-active') }}">
                        <a  href="{{ route('admin.products.chars.index') }}" aria-expanded="false">
                    ...
                    <li class="{{ active(['admin.products.brands.*', 'admin.products.brandCollections.*'], 'mm-active') }}">
                        <a  href="{{ route('admin.products.brands.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="{{ active(['admin.products.productBlocks.*'], 'mm-active') }}">
                        <a  href="{{ route('admin.products.productBlocks.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <span class="nav-text">Доп.блоки</span>
                        </a>
                    </li>
                    <li class="nav-label mt-5">Парсинг</li>

                    <li class="{{ active('admin.parser.*', 'mm-active') }}">
                        <a href="{{ route('admin.parser.parser') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <span class="nav-text">Парсер</span>
                        </a>
                    </li>
                    <li class="nav-label mt-5">Импорт/Экспорт</li>

                    <li class="{{ active('admin.products.import', 'mm-active') }}">
                        <a href="{{ route('admin.products.import') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                                    <rect fill="#000000" opacity="0.3" transform="translate(12.000000, 7.000000) rotate(-180.000000) translate(-12.000000, -7.000000) " x="11" y="1" width="2" height="12" rx="1"/>
                            ...
                            <span class="nav-text">Импорт</span>
                        </a>
                    </li>
                    <!-- <li class="">
                        <a href="" aria-expanded="false">
                            ...
                            <span class="nav-text">Импорт товаров</span>
                        </a>
                    </li> -->
                    <!-- <li class="">
                        <a href="" aria-expanded="false">
            ...
            <div class="tab-pane fade {{ active(['admin.coupons.*', 'admin.promotion.*'], 'show active') }}" id="forms">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Цены и скидки</li>
                    <li class="{{ active('admin.coupons.*', 'mm-active') }}"><a class="ai-icon" href="{{ route('admin.coupons.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <span class="nav-text">Купоны</span>
                        </a>
                    </li>
                    <li class="{{ active('admin.promotion.*', 'mm-active') }}"><a class="ai-icon" href="{{route('admin.promotion.index')}}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <span class="nav-text">Скидки</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="tab-pane fade {{ active(['admin.users.*', 'admin.admins.*'], 'show active') }}" id="users">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Пользователи</li>
                    <li class="{{ active('admin.users.*', 'mm-active') }}"><a href="{{ route('admin.users.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
                    ...
                    <li class="{{ active('admin.admins.*', 'mm-active') }}"><a href="{{ route('admin.admins.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
            ...
            <div class="tab-pane fade  {{ active(['admin.pages.*', 'admin.home.products', 'admin.content.*', 'admin.blog*'], 'show active') }}" id="extra">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Контент</li>
                    <li><a href="{{ route('admin.pages.edit', 1) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                                    <path d="M3.95709826,8.41510662 L11.47855,3.81866389 C11.7986624,3.62303967 12.2013376,3.62303967 12.52145,3.81866389 L20.0429,8.41510557 C20.6374094,8.77841684 21,9.42493654 21,10.1216692 L21,19.0000642 C21,20.1046337 20.1045695,21.0000642 19,21.0000642 L4.99998155,21.0000673 C3.89541205,21.0000673 2.99998155,20.1046368 2.99998155,19.0000673 L2.99999828,10.1216672 C2.99999935,9.42493561 3.36258984,8.77841732 3.95709826,8.41510662 Z M10,13 C9.44771525,13 9,13.4477153 9,14 L9,17 C9,17.5522847 9.44771525,18 10,18 L14,18 C14.5522847,18 15,17.5522847 15,17 L15,14 C15,13.4477153 14.5522847,13 14,13 L10,13 Z" fill="#000000"/>
                    ...
                    <li class="{{ active('admin.home.products', 'mm-active') }}">
                        <a href="{{ route('admin.home.products') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                                    <path d="M18.1446364,11.84388 L17.4471627,16.0287218 C17.4463569,16.0335568 17.4455155,16.0383857 17.4446387,16.0432083 C17.345843,16.5865846 16.8252597,16.9469884 16.2818833,16.8481927 L4.91303792,14.7811299 C4.53842737,14.7130189 4.23500006,14.4380834 4.13039941,14.0719812 L2.30560137,7.68518803 C2.28007524,7.59584656 2.26712532,7.50338343 2.26712532,7.4104669 C2.26712532,6.85818215 2.71484057,6.4104669 3.26712532,6.4104669 L16.9929851,6.4104669 L17.606173,3.78251876 C17.7307772,3.24850086 18.2068633,2.87071314 18.7552257,2.87071314 L20.8200821,2.87071314 C21.4717328,2.87071314 22,3.39898039 22,4.05063106 C22,4.70228173 21.4717328,5.23054898 20.8200821,5.23054898 L19.6915238,5.23054898 L18.1446364,11.84388 Z" fill="#000000" opacity="0.3"/>
                    ...
                    <li class="{{ active('admin.pages.*', 'mm-active') }}"><a  href="{{ route('admin.pages.index') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
                    ...
                    <li class="{{ active('admin.blog*', 'mm-active') }}">
											<a  href="{{ route('admin.blog') }}" aria-expanded="false">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
														<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    <li class="{{ active('admin.content.contacts.*', 'mm-active') }}"><a  href="{{ route('admin.content.contacts.index') }}" aria-expanded="false">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
														<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    <li class="{{ active('admin.content.payment.*', 'mm-active') }}"><a  href="{{ route('admin.content.payment.index') }}" aria-expanded="false">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
														<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    <li class="{{ active('admin.content.refund.*', 'mm-active') }}"><a  href="{{ route('admin.content.refund.index') }}" aria-expanded="false">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
														<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
                    ...
                    <li class="{{ active('admin.content.delivery.*', 'mm-active') }}"><a  href="{{ route('admin.content.delivery.index') }}" aria-expanded="false">
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24"/>
														<path d="M5.85714286,2 L13.7364114,2 C14.0910962,2 14.4343066,2.12568431 14.7051108,2.35473959 L19.4686994,6.3839416 C19.8056532,6.66894833 20,7.08787823 20,7.52920211 L20,20.0833333 C20,21.8738751 19.9795521,22 18.1428571,22 L5.85714286,22 C4.02044787,22 4,21.8738751 4,20.0833333 L4,3.91666667 C4,2.12612489 4.02044787,2 5.85714286,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
            ...
            <div class="tab-pane fade {{ active('admin.settings.*', 'show active') }}" id="settings">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Настройки</li>
                    <li class="{{ active('admin.settings.menu', 'mm-active') }}"><a href="{{ route('admin.settings.menu') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
                    ...
                    <li class="{{ active('admin.settings.keys.*', 'mm-active') }}"><a  href="{{ route('admin.settings.keys.values') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"/>
