<!--**********************************
    ...
    ***********************************-->
<div class="header">
    <div class="header-content pl-lg-0">
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50" src="/admin_assets/images/avatar/1.jpg">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="/admin_assets/images/profile/default.webp" width="20" alt=""/>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('admin.admins.edit', auth()->id()) }}" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ml-2">Профиль </span>
                            </a>
                            <a href="javascript:document.getElementById('logout_form').submit();" class="dropdown-item ai-icon">
