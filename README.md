...
```
cd existing_repo
git remote add origin https://gitlab.com/alpa.group/lime1991/backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/alpa.group/lime1991/backend/-/settings/integrations)
