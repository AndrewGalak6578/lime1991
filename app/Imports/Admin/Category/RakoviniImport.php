...
class RakoviniImport implements ToModel, WithChunkReading, WithHeadingRow, ShouldQueue
{
    /**
     * @param array $row
     */
...
//                "staraia_cena",
                ...
                "polotencederzatel",
                "dozator_zidkogo_myla",
                "bez_otverstii_pod_smesitel",
                "raspolozenie_smesitelia",
                "pereliv",
                "spec_gruppa_rakoviny"
            ];
...
//                "Старая цена",
                ...
                "Без отверстий под смеситель",
                "Расположение смесителя",
                "Перелив",
                "СПЕЦ ГРУППА - Раковины"
            ];
