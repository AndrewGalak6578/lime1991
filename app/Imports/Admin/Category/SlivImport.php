...
class SlivImport implements ToModel, WithChunkReading, WithHeadingRow, ShouldQueue
{
    /**
     * @param array $row
     */
        ...
        if(Product::where('code', $row['artikul'])->doesntExist()){
            ...
            $row_chars = [
                 "cvet",
                  ...
                  "naznacenie",
                  "tip_tovara",
                  "komplektuiushhie_dlia_dusevyx_trapov_i_lotkov",
                  "zatvor",
                  "vid_resetki",
                  "tip_sliva_pereliva"
            ];
            ...
            $db_char_names = [
                ...
                "Назначение",
                "Тип товара",
                "Комплектующие для душевых трапов и лотков",
                "Затвор",
                "Вид решётки",
                "Тип слива-перелива"
            ];
