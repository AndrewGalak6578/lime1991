...
class SmesiteliImport implements ToModel, WithChunkReading, WithHeadingRow, ShouldQueue
{
    /**
     * @param array $row
     */
...
//                "cenovaia_kategoriia",
                ...
                "standart_podvodki",
                "donnyi_klapan",
                "otverstiia_dlia_montaza_pod_smesitel",
                "spec_gruppa_smesiteli",
                "rezim_ekonomii_vody",
                "dopolnitelnye_funkcii",
                "podkliucenie_filtra_dlia_vody",
                "vstroennyi_filtr",
                "sovmestimost_s_protocnym_vodonagrevatelem",
            ];
...
//                "Ценовая категория",
                ...
                "Стандарт подводки",
                "Донный клапан",
                "Отверстия для монтажа под смеситель",
                "СПЕЦ ГРУППА - Смесители",
                "Режим экономии воды",
                "Дополнительные функции",
                "Подключение фильтра для воды",
                "Встроенный фильтр",
                "Совместимость с проточным водонагревателем"
            ];
